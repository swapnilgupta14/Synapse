    ...
    return (
        <>
            <Card
                ...
                hoverShadow="0px 6px 10px rgba(0, 0, 0, 0.1)"
            >
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                        <div
                            className={`${currentStatus.bg} ${currentStatus.text} px-3 py-1 rounded-full text-xs font-medium`}
                        >
                            {project.status}
                        </div>
                ...
                <div className="border-t border-gray-100 pt-4">
                    <button
                        className="w-full flex items-center justify-center bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800 text-sm transition-colors group/details"
                        onClick={handleOpen}
                    >
                        View Details
                        <ChevronRight
                            size={16}
                            className="ml-2 group-hover/details:translate-x-1 transition-transform"
                        />
                    </button>
                </div>
            </Card>
            ...
            {isPopupOpen && (
                <ProjectDetailsView project={project} onClose={handleClose} />
            )}
        </>
    );
};
